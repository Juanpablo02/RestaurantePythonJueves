...
class Empleado(models.Model):
    ...
    cargo_empleado = models.IntegerField()
...
class Platos(models.Model):
    ...
    descri_plato = models.CharField(max_length=200)
    foto_plato = models.CharField(max_length=200)
    precio_plato = models.IntegerField()
    tipo_plato = models.IntegerField()
